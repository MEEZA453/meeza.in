...
import {getDesign , postDesign , deleteDesign , pingServer, searchDesigns, getDefaultDesigns, editDesign, getDesignById, getDesignByHandle, addProductView, detachAssetFromProduct, attachAssetsToProduct}  from '../controller/design.js'
...
router.post("/:productId/attach",verifyToken, attachAssetsToProduct); // body: assetIds: []
router.post("/:productId/detach/:assetId",verifyToken, detachAssetFromProduct);
