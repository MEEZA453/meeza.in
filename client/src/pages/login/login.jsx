  ...
  return (
    <div className='h-[100vh] justify-center w-full flex  items-center'>
      ...
      <div className='w-96  rounded-[3px] border  border-[#464646] items-center px-5 py-4'>
        <form className='font-[inter-regular] '  ><h3 className='mb-7 '>Login</h3>
      ...
      <PasswordInput/>
        <button className='btn-primary w-full bg-white p-2 rounded my-1 mb-40 hover:bg-black-700  text-black duration-300 '>Login</button>
        </form>
